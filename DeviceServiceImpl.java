package luoxiaojia.modules.device.service.impl;
...
import luoxiaojia.common.utils.DateUtils;
import luoxiaojia.modules.device.dao.DeviceDao;
...
public class DeviceServiceImpl extends BaseServiceImpl<DeviceDao, DeviceEntity> implements DeviceService {
    ...
    public DeviceReportRespDTO checkDeviceActive(String macAddress, String clientId,
        ...
        firmware.setUrl("http://localhost:8002/luoxiaojia/ota/download");
        ...
        if (StringUtils.isBlank(wsUrl) || wsUrl.equals("null")) {
            ...
            wsUrl = "ws://luoxiaojia.server.com:8000/luoxiaojia/v1/";
            ...
            if (wsUrls.length > 0) {
                ...
                websocket.setUrl("ws://luoxiaojia.server.com:8000/luoxiaojia/v1/");
            }
        }
